...
public class TestExecutor extends TestBase {
	...
	public void testCasesExecutor(int testRow, String testCase,ITestContext context) throws Exception {
		...
		executor.executeTestCase(testCase,context);
		ExcelManager.getInstance().getExcelReader().setCellData(PASS, testRow, resultColumn, testDataPath,
				testDataSheet);
	}
