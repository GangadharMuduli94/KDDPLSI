...
public class ExcelReader {
	...
	public static synchronized String getTestTitle(String sheetName,int row) {
		XSSFSheet excelSheet = excelWorkbook.getSheet(sheetName);
		XSSFCell cell = excelSheet.getRow(row).getCell(1);
	...
	public synchronized Map<Integer, String> getTestCasesToRun(String sheetName, int runModeColumn,
			int testCaseColumn) {
