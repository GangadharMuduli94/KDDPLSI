...
public class ScreenshotUtility implements GlobalVariables {
	...
	public static String takeScreenShot(WebDriver driver, String testCaseName) {
		...
		String screenShotFilePath = screenshotFolder + testCaseName + DateUtility.getStringDate("_ddMMyyyy_HHmmss")
				+ fileFormat;
		try {
		...
		return screenShotFilePath.replace("target/html-report/", "");
	}
}
